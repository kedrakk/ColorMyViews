...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        val clickableViews:List<View> = listOf(findViewById(R.id.box_one_text),findViewById(R.id.box_two_text),findViewById(R.id.box_three_text),findViewById(R.id.box_four_text),findViewById(R.id.box_five_text),findViewById(R.id.btn_green),findViewById(R.id.btn_red),findViewById(R.id.btn_yellow))
